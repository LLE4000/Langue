...
await page.goto(base + '/#/play'); await settle(500); await shot('21-play');
await page.goto(base + '/#/play/duel'); await settle(500); await shot('22-duel-setup');
await page.getByRole('button', { name: /Lancer le duel/ }).click(); await settle(600); await shot('23-duel');
await page.locator('.half.p0 .choice[data-ok="1"]').dispatchEvent('pointerdown'); await settle(300); await shot('24-duel-point');
await page.goto(base + '/#/play/defi'); await settle(500); await shot('25-defi');
await page.goto(base + '/#/profile/people'); await settle(500); await shot('26-people');
await browser.close();
console.log('ok', out);
