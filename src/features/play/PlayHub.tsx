...
export function PlayHub() {
  ...
  return (
    <>
      <p className="lead">Apprendre à deux, c’est tenir plus longtemps. Trois façons de jouer, sans compte ni classement mondial : on se mesure à quelqu’un qu’on connaît.</p>
      <div className="list">
