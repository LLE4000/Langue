...
export function Profile() {
  ...
  return (
    <>
      ...
      <div className="h2">Mes compétences <span className="sp" /><Link to="/profile/levels">Objectif et niveaux ›</Link></div>
      <p className="sm mut" style={{ margin: '-4px 2px 10px' }}>Objectif : {goalLabel}</p>
      <div className="prog">
      ...
      <div className="list">
        ...
        <Row to="/profile/levels" ico="🎚️" t="Objectif et niveaux" s="Parler, lire et écrire · niveau par compétence" />
